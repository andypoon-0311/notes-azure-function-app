...
$ResourceGroupName = 'rgmyfunc01'
$StorageAccountName = 'storenotes111'
$FunctionAppName = 'notesfuncapp111'
$Location = 'westus3' # To see a list of all locations use: az account list-locations
